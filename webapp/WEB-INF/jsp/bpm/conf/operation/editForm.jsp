...
<div class="panel">
    ...
    <form:form id="childEditForm" method="post" commandName="m" cssClass="form-horizontal">
            ...
            <div class="control-group">
                <form:label path="value" cssClass="control-label">操作</form:label>
                <div class="controls">
                    <form:select id="value" path="value"  cssClass="validate[required], ajax[ajaxNameCall]" placeholder="请选择" >
                    	<form:options items="${bpmconfoperatetype}" itemValue="name" itemLabel="value"/>  
                    </form:select>
                </div>
            </div>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <form:input id="priority" path="priority" cssClass="validate[required, custom[integer]]" placeholder="请输入优先级"/>
                </div>
            </div>
...
<script type="text/javascript">
    $(function () {
        ...
        $.validationEngineLanguage.allRules.ajaxNameCall= {
            "url": "${ctx}/bpm/conf/operation/validate",
            //动态提取的数据。验证时一起发送
