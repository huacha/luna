    ...
    <div class="span9">
		...
		<div class="panel">
			<h4 class="hr tool">
				...
				<div class="btn-group">
	                <shiro:hasPermission name="bpm:conf:rule:update">
	                ...
	                <shiro:hasPermission name="bpm:conf:rule:delete">
				...
				<table id="childTable" class="sort-table table table-bordered table-hover">
					<thead>
						<tr>
							...
							<th style="width: 250px" sort="value">规则名称</th>
							<th >&nbsp;</th>
						</tr>
					</thead>
					<tbody>
...
<script type="text/javascript">
    $(function () {
        $.noparentchild.initParentTable({
            ...
            createUrl :      "${ctx}/bpm/conf/rule/node-${bpmConfNode.id}/create?BackURL=" +$.table.tableURL($(".table")),
            //createUrl :      "${ctx}/bpm/conf/rule/node-${bpmConfNode.id}/create",
            ...
            batchDeleteUrl : "${ctx}/bpm/conf/rule/node-${bpmConfNode.id}/batch/delete"
