 ...
 */
@Service
public class BpmTaskDefNoticeService extends BaseService<BpmTaskDefNotice, Long> {

    private BpmTaskDefNoticeManager getBpmTaskDefNoticeRepository() {
        return (BpmTaskDefNoticeManager) baseRepository;
    }
}
