...
import com.luna.sys.user.exception.UserBlockedException;
import com.luna.sys.user.exception.UserNotExistsException;
...
public class UserService extends BaseService<User, Long> {
	...
	public User login(String username, String password) {
		...
		if (StringUtils.isEmpty(username) || StringUtils.isEmpty(password)) {
			log.info(UserLogUtils.logInfo(username, "loginError",
					"username is empty"));
		...
		if (user == null || Boolean.TRUE.equals(user.getDeleted())) {
			log.info(UserLogUtils.logInfo(username, "loginError", "user is not exists!"));
		...
		if (user.getStatus() == UserStatus.blocked) {
			log.info(UserLogUtils.logInfo(username, "loginError", "user is blocked!"));
			throw new UserBlockedException(
					userStatusHistoryService.getLastReason(user));
		}

		log.info(UserLogUtils.logInfo(username, "loginSuccess", ""));
		return user;
	}
	...
	public void changePassword(User opUser, Long[] ids, String newPassword)
		...
		for (Long id : ids) {
			...
			log.info(UserLogUtils.logInfo(user.getUsername(), "changePassword",
	...
	public void changeStatus(User opUser, Long[] ids, UserStatus newStatus,
		...
		for (Long id : ids) {
			...
			log.info(UserLogUtils.logInfo(user.getUsername(), "changeStatus",
